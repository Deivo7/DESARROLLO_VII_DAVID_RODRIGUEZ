...
function mayorVaInve($inv){
        foreach ($inv as $producto => $info) {
            $valorTotal = $info ['cantidad']* $info ['precio'];
            $valorMaximo =0; // se inicia la variable del valor maximo en 0, hago asi para que no marque erro
        ...
        $productoMayorValor = mayorVaInve($inventario);
        echo "<br>";
        echo "\n El producto con mayor valor es: $productoMayorValor";
?>